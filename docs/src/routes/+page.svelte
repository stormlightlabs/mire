...
<main id="main-content" class="landing">
	<section class="landing-hero" aria-labelledby="landing-title">
		...
		<p class="landing-lede">
			Mire is a local code review environment for humans and agents. Inspect changes, leave anchored
			feedback, and keep the review intact as the code evolves.
		</p>
	...
	<section class="landing-docs" aria-labelledby="docs-title">
		<div class="section-heading">
			<p class="eyebrow">Read the manual</p>
